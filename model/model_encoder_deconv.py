...
class SegNet(nn.Module):
    def __init__(self, output_size=32, *args, **kwargs) -> None:
        ...
        # OTHER LAYERS
        self.upsampling_1 = nn.ConvTranspose2d(512, 512, kernel_size=4, stride=2, padding=1)
        self.upsampling_2 = nn.ConvTranspose2d(1024, 1024, kernel_size=4, stride=2, padding=1)
        self.upsampling_3 = nn.ConvTranspose2d(512, 512, kernel_size=4, stride=2, padding=1)
        self.upsampling_4 = nn.ConvTranspose2d(256, 256, kernel_size=4, stride=2, padding=1)
        self.upsampling_5 = nn.ConvTranspose2d(128, 128, kernel_size=4, stride=2, padding=1)
    ...
    def forward(self, x):
        ...
        upsampled = self.upsampling_1(bottleneck)
        ...
        upsampled = self.upsampling_2(upsampled)
        ...
        upsampled = self.upsampling_3(upsampled)
